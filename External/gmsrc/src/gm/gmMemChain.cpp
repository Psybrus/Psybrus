...
gmMemChain::gmMemChain(gmuptr a_elementSize, gmuptr a_numElementsInChunk)
{
...
void* gmMemChain::AllocBytes(gmuptr a_numBytes, gmuptr a_alignNumBytes)
{
...
void* gmMemChain::Alloc(gmuptr a_numElementsToAlloc)
{
  gmuptr allocSize;
  void *retPtr;
...
gmuptr gmMemChain::GetSystemMemUsed() const
{
