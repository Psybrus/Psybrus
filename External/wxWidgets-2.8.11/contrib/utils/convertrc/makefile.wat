...
CONVERTRC_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
	...
	-dNOPCH -i=.\..\..\include $(__RTTIFLAG_7) $(__EXCEPTIONSFLAG_8) $(CPPFLAGS) &
	$(CXXFLAGS)
CONVERTRC_OBJECTS =  &
...
$(OBJS)\convertrc.exe :  $(CONVERTRC_OBJECTS) $(OBJS)\convertrc_wxconvert.res
	...
	@%append $(OBJS)\convertrc.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
