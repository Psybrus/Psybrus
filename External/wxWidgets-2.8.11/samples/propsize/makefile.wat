...
PROPSIZE_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
...
all : .SYMBOLIC $(OBJS)\propsize.exe
...
$(OBJS)\propsize.exe :  $(PROPSIZE_OBJECTS) $(OBJS)\propsize_propsize.res
	@%create $(OBJS)\propsize.lbc
	@%append $(OBJS)\propsize.lbc option quiet
	@%append $(OBJS)\propsize.lbc name $^@
	@%append $(OBJS)\propsize.lbc option caseexact
	@%append $(OBJS)\propsize.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(PROPSIZE_OBJECTS)) do @%append $(OBJS)\propsize.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__GDIPLUS_LIB_p) $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib odbc32.lib) do @%append $(OBJS)\propsize.lbc library %i
	@%append $(OBJS)\propsize.lbc option resource=$(OBJS)\propsize_propsize.res
	@for %i in () do @%append $(OBJS)\propsize.lbc option stack=%i
	wlink @$(OBJS)\propsize.lbc

$(OBJS)\propsize_propsize.obj :  .AUTODEPEND .\propsize.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(PROPSIZE_CXXFLAGS) $<
