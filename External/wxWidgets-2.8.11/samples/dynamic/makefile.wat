...
DYNAMIC_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
...
$(OBJS)\dynamic.exe :  $(DYNAMIC_OBJECTS) $(OBJS)\dynamic_dynamic.res
	@%create $(OBJS)\dynamic.lbc
	@%append $(OBJS)\dynamic.lbc option quiet
	@%append $(OBJS)\dynamic.lbc name $^@
	@%append $(OBJS)\dynamic.lbc option caseexact
	@%append $(OBJS)\dynamic.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(DYNAMIC_OBJECTS)) do @%append $(OBJS)\dynamic.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__GDIPLUS_LIB_p) $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib odbc32.lib) do @%append $(OBJS)\dynamic.lbc library %i
	@%append $(OBJS)\dynamic.lbc option resource=$(OBJS)\dynamic_dynamic.res
	@for %i in () do @%append $(OBJS)\dynamic.lbc option stack=%i
	wlink @$(OBJS)\dynamic.lbc

$(OBJS)\dynamic_dynamic.obj :  .AUTODEPEND .\dynamic.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(DYNAMIC_CXXFLAGS) $<
