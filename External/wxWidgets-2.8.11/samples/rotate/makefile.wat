...
ROTATE_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
...
all : .SYMBOLIC $(OBJS)\rotate.exe data
...
$(OBJS)\rotate.exe :  $(ROTATE_OBJECTS) $(OBJS)\rotate_rotate.res
	@%create $(OBJS)\rotate.lbc
	@%append $(OBJS)\rotate.lbc option quiet
	@%append $(OBJS)\rotate.lbc name $^@
	@%append $(OBJS)\rotate.lbc option caseexact
	@%append $(OBJS)\rotate.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(ROTATE_OBJECTS)) do @%append $(OBJS)\rotate.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__GDIPLUS_LIB_p) $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib odbc32.lib) do @%append $(OBJS)\rotate.lbc library %i
	@%append $(OBJS)\rotate.lbc option resource=$(OBJS)\rotate_rotate.res
	@for %i in () do @%append $(OBJS)\rotate.lbc option stack=%i
	wlink @$(OBJS)\rotate.lbc
...
$(OBJS)\rotate_rotate.obj :  .AUTODEPEND .\rotate.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(ROTATE_CXXFLAGS) $<
