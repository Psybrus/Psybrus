...
$(OBJS)\png.exe :  $(PNG_OBJECTS) $(OBJS)\png_pngdemo.res
	@%create $(OBJS)\png.lbc
	@%append $(OBJS)\png.lbc option quiet
	@%append $(OBJS)\png.lbc name $^@
	@%append $(OBJS)\png.lbc option caseexact
	@%append $(OBJS)\png.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(PNG_OBJECTS)) do @%append $(OBJS)\png.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__GDIPLUS_LIB_p) $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib odbc32.lib) do @%append $(OBJS)\png.lbc library %i
	@%append $(OBJS)\png.lbc option resource=$(OBJS)\png_pngdemo.res
	@for %i in () do @%append $(OBJS)\png.lbc option stack=%i
	wlink @$(OBJS)\png.lbc

$(OBJS)\png_pngdemo.obj :  .AUTODEPEND .\pngdemo.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(PNG_CXXFLAGS) $<
