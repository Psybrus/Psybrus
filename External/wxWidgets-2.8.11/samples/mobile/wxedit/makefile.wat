...
WXEDIT_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
...
clean : .SYMBOLIC 
	...
	-if exist $(OBJS)\wxedit.exe del $(OBJS)\wxedit.exe

$(OBJS)\wxedit.exe :  $(WXEDIT_OBJECTS) $(OBJS)\wxedit_sample.res
	@%create $(OBJS)\wxedit.lbc
	@%append $(OBJS)\wxedit.lbc option quiet
	@%append $(OBJS)\wxedit.lbc name $^@
	@%append $(OBJS)\wxedit.lbc option caseexact
	@%append $(OBJS)\wxedit.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(WXEDIT_OBJECTS)) do @%append $(OBJS)\wxedit.lbc file %i
	@for %i in ( $(__WXLIB_CORE_p)  $(__WXLIB_BASE_p)  $(__WXLIB_MONO_p) $(__LIB_TIFF_p) $(__LIB_JPEG_p) $(__LIB_PNG_p)  wxzlib$(WXDEBUGFLAG).lib  wxregex$(WXUNICODEFLAG)$(WXDEBUGFLAG).lib wxexpat$(WXDEBUGFLAG).lib $(EXTRALIBS_FOR_BASE)  $(__GDIPLUS_LIB_p) $(__CAIRO_LIB_p) kernel32.lib user32.lib gdi32.lib comdlg32.lib winspool.lib winmm.lib shell32.lib comctl32.lib ole32.lib oleaut32.lib uuid.lib rpcrt4.lib advapi32.lib wsock32.lib odbc32.lib) do @%append $(OBJS)\wxedit.lbc library %i
	@%append $(OBJS)\wxedit.lbc option resource=$(OBJS)\wxedit_sample.res
	@for %i in () do @%append $(OBJS)\wxedit.lbc option stack=%i
...
$(OBJS)\wxedit_wxedit.obj :  .AUTODEPEND .\wxedit.cpp
	$(CXX) -bt=nt -zq -fo=$^@ $(WXEDIT_CXXFLAGS) $<
