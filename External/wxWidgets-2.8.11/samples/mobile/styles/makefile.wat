...
STYLES_CXXFLAGS = $(__DEBUGINFO_0) $(__OPTIMIZEFLAG_2) $(__THREADSFLAG_5) &
...
all : .SYMBOLIC $(OBJS)\styles.exe data
...
clean : .SYMBOLIC 
	...
	-if exist $(OBJS)\styles.exe del $(OBJS)\styles.exe

$(OBJS)\styles.exe :  $(STYLES_OBJECTS) $(OBJS)\styles_sample.res
	@%create $(OBJS)\styles.lbc
	@%append $(OBJS)\styles.lbc option quiet
	@%append $(OBJS)\styles.lbc name $^@
	@%append $(OBJS)\styles.lbc option caseexact
	@%append $(OBJS)\styles.lbc  $(__DEBUGINFO_1)  libpath $(LIBDIRNAME) system nt_win ref '_WinMain@16' $(____CAIRO_LIBDIR_FILENAMES_p) $(LDFLAGS)
	@for %i in ($(STYLES_OBJECTS)) do @%append $(OBJS)\styles.lbc file %i
	...
	@%append $(OBJS)\styles.lbc option resource=$(OBJS)\styles_sample.res
	@for %i in () do @%append $(OBJS)\styles.lbc option stack=%i
	wlink @$(OBJS)\styles.lbc
