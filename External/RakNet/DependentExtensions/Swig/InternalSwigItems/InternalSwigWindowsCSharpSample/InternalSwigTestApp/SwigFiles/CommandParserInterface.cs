...
public class CommandParserInterface : IDisposable {
  ...
  public SystemAddress IntegersToSystemAddress(int binaryAddress, int port) {
    SystemAddress ret = new SystemAddress(RakNetPINVOKE.CommandParserInterface_IntegersToSystemAddress(swigCPtr, binaryAddress, port), true);
    return ret;
  }
