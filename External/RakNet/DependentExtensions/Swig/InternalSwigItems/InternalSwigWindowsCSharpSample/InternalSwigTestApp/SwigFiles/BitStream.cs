...
public class BitStream : IDisposable {
  ...
  public void Write(SWIGTYPE_p_unsigned_char inTemplateVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_4(swigCPtr, SWIGTYPE_p_unsigned_char.getCPtr(inTemplateVar));
  }
  ...
  public void WriteCompressed(SWIGTYPE_p_unsigned_char inTemplateVar) {
    RakNetPINVOKE.BitStream_WriteCompressed__SWIG_2(swigCPtr, SWIGTYPE_p_unsigned_char.getCPtr(inTemplateVar));
  }
  ...
  public void Write(byte[] inputByteArray, uint numberOfBytes) {
    RakNetPINVOKE.BitStream_Write__SWIG_7(swigCPtr, inputByteArray, numberOfBytes);
  }
  ...
  public void Write(RakString inTemplateVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_15(swigCPtr, RakString.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Write(RakNetGUID inTemplateVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_16(swigCPtr, RakNetGUID.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Write(uint24_t inTemplateVar) {
    RakNetPINVOKE.BitStream_Write__SWIG_17(swigCPtr, uint24_t.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void WriteCompressed(RakString inTemplateVar) {
    RakNetPINVOKE.BitStream_WriteCompressed__SWIG_12(swigCPtr, RakString.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void WriteCompressed(RakNetGUID inTemplateVar) {
    RakNetPINVOKE.BitStream_WriteCompressed__SWIG_13(swigCPtr, RakNetGUID.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }

  public void WriteCompressed(uint24_t inTemplateVar) {
    RakNetPINVOKE.BitStream_WriteCompressed__SWIG_14(swigCPtr, uint24_t.getCPtr(inTemplateVar));
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
  }
