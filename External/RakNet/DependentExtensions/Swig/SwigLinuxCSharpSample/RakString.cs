...
public class RakString : IDisposable {
  ...
  public RakString CopyData(char c) {
    RakString ret = new RakString(RakNetPINVOKE.RakString_CopyData__SWIG_2(swigCPtr, c), false);
    return ret;
  }
  ...
  public static uint nPos {
    set {
      RakNetPINVOKE.RakString_nPos_set(value);
    } 
    get {
      uint ret = RakNetPINVOKE.RakString_nPos_get();
      return ret;
    } 
  }
