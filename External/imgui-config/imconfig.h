...
#define IM_VEC2_CLASS_EXTRA                                                 \
        ImVec2(const MaVec2& f) { x = f.x(); y = f.y(); }                   \
        operator MaVec2() const { return MaVec2(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                 \
        ImVec4(const MaVec4& f) { x = f.x(); y = f.y(); z = f.z(); w = f.w(); } \
        operator MaVec4() const { return MyVec4(x,y,z,w); }
