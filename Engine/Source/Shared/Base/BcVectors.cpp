...
void BcVec2d::lerp(const BcVec2d& A, const BcVec2d& B, BcF32 T)
{
...
void BcVec3d::lerp(const BcVec3d& A, const BcVec3d& B, BcF32 T)
{
	const BcF32 lK0 = 1.0f - T;
	const BcF32 lK1 = T;
...
void BcVec4d::lerp(const BcVec4d& A, const BcVec4d& B, BcF32 T)
{
	const BcF32 lK0 = 1.0f - T;
	const BcF32 lK1 = T;
