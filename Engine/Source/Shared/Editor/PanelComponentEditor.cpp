...
namespace Editor
{
	//////////////////////////////////////////////////////////////////////////
	// Register
	void PanelComponentEditor::Register( SceneContext& SceneContext )
	{
	DsCore::pImpl()->registerPanel( "Scene", "Component Editor", "Ctrl+Shift+E", 
		PanelComponentEditor( SceneContext ) );
	}

	//////////////////////////////////////////////////////////////////////////
	// Ctor
	PanelComponentEditor::PanelComponentEditor( SceneContext& SceneContext ):
	...
	//////////////////////////////////////////////////////////////////////////
	// Copy Ctor
	PanelComponentEditor::PanelComponentEditor( const PanelComponentEditor& Other ):
	...
	//////////////////////////////////////////////////////////////////////////
	// Callable
	void PanelComponentEditor::operator()( BcU32 )
	{
