...
void RsSamplerStateDesc::StaticRegisterClass()
{
	ReField* Fields[] = 
	{
		...
		new ReField( "MinFilter_", &RsSamplerStateDesc::MinFilter_ ),
		new ReField( "MagFilter_", &RsSamplerStateDesc::MagFilter_ ),
...
RsSamplerStateDesc::RsSamplerStateDesc( ReNoInit ):
	...
	MinFilter_( RsTextureFilteringMode::NEAREST_MIPMAP_LINEAR ),
	MagFilter_( RsTextureFilteringMode::NEAREST ),
	MipLODBias_( 0.0f ),
	MaxAnisotropy_( 1 ),
