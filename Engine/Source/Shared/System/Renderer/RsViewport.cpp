...
//////////////////////////////////////////////////////////////////////////
// orthoProj
void RsViewport::orthoProj( BcReal Left, BcReal Right, BcReal Bottom, BcReal Top, BcReal Near, BcReal Far )
{
...
//////////////////////////////////////////////////////////////////////////
// perspProj
void RsViewport::perspProj( BcReal Fov, BcReal Aspect, BcReal Near, BcReal Far )
{
...
//////////////////////////////////////////////////////////////////////////
// frustum
void RsViewport::frustum( BcReal Left, BcReal Right, BcReal Bottom, BcReal Top, BcReal Near, BcReal Far )
{
	Projection_[0][0] = ( 2.0f * Near ) / ( Right - Left );
	Projection_[0][1] = 0.0f;
	Projection_[0][2] = 0.0f;
	Projection_[0][3] = 0.0f;

	Projection_[1][0] = 0.0f;
	Projection_[1][1] = ( 2.0f * Near ) / ( Bottom - Top );
	Projection_[1][2] = 0.0f;
	Projection_[1][3] = 0.0f;

	Projection_[2][0] = -( Right + Left ) / ( Right - Left );
	Projection_[2][1] = -( Top + Bottom ) / ( Bottom - Top );
	Projection_[2][2] = ( Far + Near ) / ( Far - Near );
	Projection_[2][3] = 1.0f;

	Projection_[3][0] = 0.0f;
	Projection_[3][1] = 0.0f;
	Projection_[3][2] = -( 2.0f * Far * Near ) / ( Far - Near );
