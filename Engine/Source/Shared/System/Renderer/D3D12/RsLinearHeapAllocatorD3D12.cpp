...
RsLinearHeapAllocatorD3D12::ResourceBlock RsLinearHeapAllocatorD3D12::createResourceBlock( BcU64 Size )
{
	...
	CD3D12_HEAP_PROPERTIES HeapProperties( HeapType_ );
	CD3D12_RESOURCE_DESC ResourceDesc( CD3D12_RESOURCE_DESC::Buffer( Block.Size_, D3D12_RESOURCE_MISC_NONE, MAX_ALIGNMENT ) );

	// Setup appropriate resource usage.
	D3D12_RESOURCE_USAGE ResourceUsage = 
		( HeapType_ == D3D12_HEAP_TYPE_UPLOAD ) ? 
			D3D12_RESOURCE_USAGE_GENERIC_READ : D3D12_RESOURCE_USAGE_COPY_DEST;
