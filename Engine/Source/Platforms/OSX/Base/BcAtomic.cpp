...
#define ATOMIC_TEST_EXCHANGE( _T, _ia, _ib )								\
	...
	ATOMIC_TEST( AtomicA == (_T)_ib && B == (_T)_ia, "Exchange:" #_T );	\
}
...
#define ATOMIC_TEST_PREDEC( _T, _ia )										\
	...
	_T A = (_T)_ia;														\
	_T Result = --A;													\
	ATOMIC_TEST( AtomicResult == Result, "Predecrement:" #_T "," #_ia );			\
}
...
#define ATOMIC_TEST_PREINC( _T, _ia )										\
	...
	_T A = (_T)_ia;														\
	_T Result = ++A;													\
	ATOMIC_TEST( AtomicResult == Result, "Preincrement:" #_T "," #_ia );			\
}
...
#define ATOMIC_TEST_POSTDEC( _T, _ia )										\
	...
	_T A = (_T)_ia;														\
	_T Result = A--;													\
	ATOMIC_TEST( AtomicResult == Result, "Postdecrement:" #_T "," #_ia );			\
}
...
#define ATOMIC_TEST_POSTINC( _T, _ia )										\
	...
	_T A = (_T)_ia;														\
	_T Result = A++;													\
	ATOMIC_TEST( AtomicResult == Result, "Postincrement:" #_T "," #_ia );			\
}
