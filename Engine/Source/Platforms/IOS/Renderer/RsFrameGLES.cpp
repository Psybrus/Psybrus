...
public:
	void render()
	{
		//RsCore::pImpl< RsCoreImplGLES >()->setViewport( &Viewport_ );	
	}
...
//////////////////////////////////////////////////////////////////////////
// Ctor
RsFrameGLES::RsFrameGLES( BcHandle DeviceHandle, BcU32 Width, BcU32 Height, BcU32 NoofNodes, BcU32 NodeMem )
{
...
//////////////////////////////////////////////////////////////////////////
// deviceHandle
BcHandle RsFrameGLES::deviceHandle() const
{
...
//////////////////////////////////////////////////////////////////////////
// height
BcU32 RsFrameGLES::height() const
{
	return Height_;
}
...
//////////////////////////////////////////////////////////////////////////
// render
void RsFrameGLES::render()
{
	// 
	BcAssertMsg( pCurrPrimitive_ == NULL, "RsFrameGLES: Unterminated primitive." );
...
//////////////////////////////////////////////////////////////////////////
// setRenderTarget
void RsFrameGLES::setRenderTarget( RsRenderTarget* pRenderTarget )
{
...
//////////////////////////////////////////////////////////////////////////
// setViewport
void RsFrameGLES::setViewport( const RsViewport& Viewport )
{
	// Assertions.
	BcAssertMsg( pCurrRenderTarget_ != NULL, "RsFrameGLES: Render target not set." );
	...
	// Assertions.
	BcAssertMsg( CurrViewport_ <= RS_SORT_VIEWPORT_MAX, "RsFrameGLES: Viewport limit exceeded." );
...
//////////////////////////////////////////////////////////////////////////
// addInstance
void RsFrameGLES::addRenderNode( RsRenderNode* pNode )
{
...
//////////////////////////////////////////////////////////////////////////
// beginPrimitive
void RsFrameGLES::beginPrimitive( eRsPrimitiveType Type, eRsFramePrimitiveMode PrimitiveMode, BcU32 Layer )
{
	BcAssertMsg( pCurrPrimitive_ == NULL, "RsFrameGLES: Primitive already started." );
	BcBreakpoint;
...
//////////////////////////////////////////////////////////////////////////
// addLine
void RsFrameGLES::addLine( const BcVec2d& PointA, const BcVec2d& PointB, const RsColour& Colour, BcU32 Layer )
{
	BcBreakpoint;
...
//////////////////////////////////////////////////////////////////////////
// addLine
void RsFrameGLES::addLine( const BcVec3d& PointA, const BcVec3d& PointB, const RsColour& Colour, BcU32 Layer )
{
	BcBreakpoint;
...
//////////////////////////////////////////////////////////////////////////
// addBox
void RsFrameGLES::addBox( const BcVec2d& CornerA, const BcVec2d& CornerB, const RsColour& Colour, BcU32 Layer )
{
	BcBreakpoint;
	...
	// If we've got no prim list, just add the node now.
	pNode->pEffect_ = RsCore::pImpl()->getDefaultEffect( rsFX_GEO_2D );
	pNode->PrimType_= rsPT_TRIANGLESESTRIP;
	pNode->NoofPrims_ = 2;
	pNode->VertexFormat_ = TVertex2D::VERTEX_TYPE;
	pNode->VertexStride_ = sizeof( TVertex2D );
	pNode->pVertices_ = pVertices;
...
//////////////////////////////////////////////////////////////////////////
// addSprite
void RsFrameGLES::addSprite( RsMaterial* pMaterial, const BcVec2d& Position )
{
	BcBreakpoint;
...
//////////////////////////////////////////////////////////////////////////
// addPrimitive
void RsFrameGLES::addPrimitive( RsMaterial* pMaterial, RsEffect* pEffect, eRsPrimitiveType Type, BcU32 NoofPrimitives, BcU32 VertexFormat, const void* pVertices, BcU32 Layer, BcU32 Depth )
{
	BcBreakpoint;
...
//////////////////////////////////////////////////////////////////////////
// allocMem
void* RsFrameGLES::allocMem( BcSize Bytes )
{
	BcU8* pMem = pCurrFrameMem_;
	pCurrFrameMem_ += Bytes;
	BcAssertMsg( BcU32( pCurrFrameMem_ - pMem ) < FrameBytes_, "RsFrameGLES: Out of memory." );
	return pMem;
}

//////////////////////////////////////////////////////////////////////////
// sortNodes
void RsFrameGLES::sortNodes()
{
...
//////////////////////////////////////////////////////////////////////////
// sortNodeRadix
void RsFrameGLES::sortNodeRadix( BcU32 Bits, BcU32 NoofItems, RsRenderNode** pSrc, RsRenderNode** pDst )
{
